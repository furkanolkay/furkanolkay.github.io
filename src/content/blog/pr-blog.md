...
categories: []
keywords: []
slug: /@furkanolkay/how-to-create-open-source-project-pr
...
![pr_create_image](/img/1__b8WahzGvaPd3W9nEyZprYQ.png)
...
![pr_create_image](/img/1__QP1L7hFBL5mNCMgO7pv2kw.png)
...
![pr_create_image](/img/1__JXEetYYoe81WiUeWPFbtDw.png) ![pr_create_image](/img/1__G71ZsHj2Wz2x3M__U4aFQLA.png)
...
![pr_create_image](/img/1__GT86s9NA3VoZW5GyvWmC4w.png)
...
![pr_create_image](/img/1__dXr7w4xQPyfreGH8Gb2DIw.png)
...
![pr_create_image](/img/1__Iv__i__Fc4OKGeMxUzS__n2yw.png)

Now, let's check the details of the open **_issue_**.

![pr_create_image](/img/1__u5AtMgQNFIkfH__qNto1w__A.png)

Let's simply complete the chosen topic.

![pr_create_image](/img/1__NvUMrGzGlXVgHllRu5nqsQ.png)

Now that we have done the necessary work, we can start the **_PR_** process after making the required **_commits_**.

![pr_create_image](/img/1__FMc4I34PwlH5t9yxm4Jszg.png)

Let's push our **_commits_**!

![pr_create_image](/img/1__FhsL1mJN86kU71a9lWod3g.png)
...
![pr_create_image](/img/1__CM__exz7cXNbTzUmPUtMPBg.png)
...
![pr_create_image](/img/1__2YoiknNStzsjf9n3iqFROA.png)

By clicking **_Create pull request_**, we create our **_PR_**. We are greeted with a screen like this.

![pr_create_image](/img/1__ZBXyMGTgDeOtMPXa2eWaTg.png)
